...
**Linear and Github:**
- This project uses Linear for project management and Github for version control.
- Access these tools via core-memory using the "get_integrations" tool
- Do not use other github or linear tools unless explicitly asked by the user or you are unable to access them via core-memory first. 